...
import { angleFromHorizontal, midpoint, torsoAngleVsWaterline } from "./mathHelpers.js";
...
// Shoulders above hips -> torso leans forward, positive angle.
assert.ok(torsoAngleVsWaterline({ x: 0.5, y: 0.3 }, { x: 0.5, y: 0.6 }) > 0);
